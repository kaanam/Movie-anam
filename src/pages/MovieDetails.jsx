...
const MovieDetails = () => {
  ...
  return (
    <div>
      <div className="">
        <div className="absolute w-full h-[100vh]  bg-gradient-to-r from-black">"{">"}
          {" "}
        </div>
        <img
      ...
      <div className="flex justify-center ">
        <div className="flex flex-col items-center md:flex-row md:max-w-2xl lg:max-w-3xl absolute xl:max-w-4xl md:mt-[-300px] mt-[-200px] text-white ">        
          ...
          <div className="float-left w-[70%] md:pl-12 ">
            ...
            <p className="text-white-300 mb-8">{movieData.overview} </p>
            <button onClick={() => setShowModal(true)}className="py-2.5 px-5 flex flex-row items-center rounded-full bg-red-500 hover:bg-red-400 mb-8 md:mb-0"
            >
